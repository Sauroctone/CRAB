...
Shader "Wind/WindTunnel"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float lerpResult68 = lerp( 0.0 , tex2Dlod( _TextureSample0, float4( panner54, 0, 0.0) ).r , _StrokeAIntensity);
			o.texcoord_5.xy = v.texcoord.xy * _StrokeBTiling + float2( 0,0 );
			float2 panner58 = ( o.texcoord_5 + _Time.y * _SpeedStrokeB);
			float lerpResult72 = lerp( 0.0 , tex2Dlod( _TextureSample1, float4( panner58, 0, 0.0) ).r , _StrokeBIntensity);
			o.texcoord_6.xy = v.texcoord.xy * _StrokeCTiling + float2( 0,0 );
			float2 panner62 = ( o.texcoord_6 + _Time.y * _SpeedStrokeC);
			float lerpResult73 = lerp( 0.0 , tex2Dlod( _TextureSample2, float4( panner62, 0, 0.0) ).r , _StrokeCIntensity);
			float3 ase_vertexNormal = v.normal.xyz;
			v.vertex.xyz += ( ( ( lerpResult68 + lerpResult72 + lerpResult73 ) * ase_vertexNormal ) / 3.0 );
		}
...
/*ASEBEGIN
Version=13501
136;673;1585;823;1424.971;775.6487;2.103422;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;109;169.4227,-182.4837;Float;False;Constant;_Float0;Float 0;25;0;3;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;108;379.7651,-228.7588;Float;False;2;0;FLOAT3;0.0;False;1;FLOAT;0,0,0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;680.3398,-468.4676;Float;False;True;6;Float;ASEMaterialInspector;0;0;StandardSpecular;Wind/WindTunnel;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;Off;0;0;False;0;0;Transparent;0.3;True;True;0;False;Transparent;Transparent;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;0;0;0;0;False;1;1;10;25;False;0.5;True;2;SrcAlpha;OneMinusSrcAlpha;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=55A56B811C41FA1E9F8D120B6420ECFF8C43CCC8